...
ServicePublic::ServicePublic(int position, std::string classe, int loyer[4], std::string nom, int prix, std::string type_couleur) : CasePropriete(position, classe, nom, prix, type_couleur) {
    for (int i = 0; i < 4; i++) {
